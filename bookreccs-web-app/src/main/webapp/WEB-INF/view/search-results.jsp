...
<div class="container">
	<div class="card border-0 shadow my-5">
		<div class="card-body p-5">
			<h1 class="font-weight-light text-center">Book Search Results</h1>
			<table class="table table-hover">
				<thead>
					<tr>
						...
						<th scope="col" style="text-align: center;">Add Book</th>
					</tr>
				</thead>
				...
				<tbody>
					<c:forEach items="${bookList}" var="book" varStatus="loop">
						...
						<tr>
							<form:form
								action="${pageContext.request.contextPath}/library/confirm"
								modelAttribute="bookToAdd">
								...
								<td style="text-align: center;"><button type="submit"
										value="Submit" class="btn btn-primary btn">Add</button>
							</form:form>
