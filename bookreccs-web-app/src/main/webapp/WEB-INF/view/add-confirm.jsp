		...
		<div class="card-body p-5">
			<div class="row">
				<div class="col-12 mb-3" align="center">
					<h1 class="font-weight-light text-center">${bookToAdd.title}</h1>
					<h2 class="font-weight-light text-center">Added to Library</h2>
				</div>
				<div class="col-12 mb-3" align="center">
					<img src="${bookToAdd.imageLink}" class="mx-auto img-responsive">
				</div>
				<div class="col-12 mb-3" align="center">
					<div class="text-center">
						<a class="btn btn-primary btn-large btn-block"
							href="${pageContext.request.contextPath}/library/"> Back To
							Library </a>
					</div>
				</div>
			</div>
