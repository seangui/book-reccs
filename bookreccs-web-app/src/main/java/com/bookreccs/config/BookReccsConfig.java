...
@ComponentScan(basePackages="com.bookreccs")
@PropertySource("classpath:persistence.properties")
public class BookReccsConfig implements WebMvcConfigurer {
	...
	// define a bean for ViewResolver - this tells us where to find the different views (.jsp pages)
	@Bean
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // contains our webjars - bootstrap + jquery
        registry
